...
DECLARE
    ...
    intersectionToJeff VARCHAR := 'At the intersection, turn left and cross the bridge.';
BEGIN
    ...
    INSERT INTO imaging (appointment_type, appointment_name, main_location_id, floor, suite) VALUES (3, 'Labs/EKG', 2, '1st', 'Room 159c');
